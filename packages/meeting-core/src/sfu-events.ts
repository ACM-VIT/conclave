...
export const SFU_EVENTS = {
  ...
  clientToServer: {
    ...
    setProducerTransportNetworkProfile: "setProducerTransportNetworkProfile",
    produce: "produce",
    consume: "consume",
    resumeConsumer: "resumeConsumer",
    setConsumerPreferences: "setConsumerPreferences",
    setConsumerPreferencesBatch: "setConsumerPreferencesBatch",
    abortConsumerHandoff: "abortConsumerHandoff",
    closeConsumer: "closeConsumer",
    closeProducer: "closeProducer",
    requestProducerKeyFrame: "requestProducerKeyFrame",
  ...
  serverToClient: {
    ...
    webcamReceiverCapacityProof: "webcamReceiverCapacityProof",
